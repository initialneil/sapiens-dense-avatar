...
####-----------------MODEL_CARD----------------------------
DATASET='bedlam'
MODEL="sapiens_0.3b_xyziuv-1024x768"
...
###--------------------------------------------------------------
CONFIG_FILE=configs/dense_avatar/${DATASET}/${MODEL}.py
# OUTPUT_DIR="Outputs/train/${DATASET}/${MODEL}/node" ## output directory for training
OUTPUT_DIR='/mnt/Getea/Datasets/BEDLAM/images/output-sapiens-xyziuv/sapiens_0.3b_xyziuv_static1k'
