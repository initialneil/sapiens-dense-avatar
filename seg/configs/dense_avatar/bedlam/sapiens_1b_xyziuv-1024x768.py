...
# pretrained_checkpoint="/home/sapiens_host/pretrain/checkpoints/sapiens_0.3b/sapiens_0.3b_epoch_1600_clean.pth"
pretrained_checkpoint = "/mnt/Getea/Models/Sapiens/sapiens_0.3b_epoch_1600_clean.pth"

## dataset root path
dataset_train = dict(
        type='DenseAvatarGeneralDataset',
        data_root='/mnt/Getea/Datasets/BEDLAM/images/test-2025.4.15-set1',
...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=[
            dict(type='XYZIUV_XYZ_MSELoss', reduction='mean', loss_weight=1.0),
            dict(type='XYZIUV_I_CELoss', reduction='mean', loss_weight=1.0),
            dict(type='XYZIUV_UV_MSELoss', reduction='mean', loss_weight=1.0),
        ],
    ),
...
default_hooks = dict(
    ...
    visualization=dict(type='XYZIUVVisualizationHook', interval=vis_every_iters, max_samples=4, vis_image_width=384, vis_image_height=512),
    )
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='DenseAvatarCombinedDataset', #
